...
const HomeSection = () => {
  ...
  return (
    ...
    >
      <div className={'grid grid-cols-12 flex items-center justify-center w-[1200px] mx-auto gap-x-[50px]'}>
        <div className={'col-span-6'}>
          <h1 className={'text-7xl text-[#fff]'}>World's most secure wallet</h1>

          <p className={'text-xl text-[#fff] my-[30px]'}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Convallis id egestas eu risus dignissim. Nunc, viverra volutpat nam sollicitudin.</p>

          <div className={'flex items-center gap-x-4'}>
            <DownloadButton>Download Now</DownloadButton>
            <Button className={'border-none text-xl text-[#fff] hover:text-[#fff]'}>
              See Features
            </Button>
          </div>
        </div>
